    ...
    <div>
        ...
        <div className="container mt-16">
            <form action="" className='mt-2 p-2 container mb-2'>
                <div className="border-[1px] bg-gray-100 border-gray-300 p-2 rounded-lg flex justify-between items-center" >
                    <div className='w-full flex items-center'>
                        <AiOutlineSearch className='mr-2 h-6 w-6 font-semibold'/>
                        <input type="text" placeholder="search a product" className="outline-none w-full bg-gray-100"
